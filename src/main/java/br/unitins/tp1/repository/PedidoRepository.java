...
public class PedidoRepository implements PanacheRepository<Pedido> {
    ...
    public List<Pedido> findEligibleReviews(Long idCliente, Long idCapacete){
        ...
        jpql.append("AND i.lote.capacete.id = ?1 ");
        jpql.append("AND p.cliente.id = ?2 ");

        return find(jpql.toString(), idCapacete, idCliente).list();
    }
