...
public class FuncionarioServiceImpl implements FuncionarioService {
    ...
    @Override
    @Transactional
    public void updateEnderecoEspecifico(Long id, Long idEndereco, EnderecoDTO dto) {
        if (dto == null)
            throw new ValidationException("dto", "Informe os campos necessarios");
    ...
    @Override
    @Transactional
    public void updateEndereco(Long id, List<EnderecoDTO> dto) {
        if (dto == null)
            throw new ValidationException("dto", "Informe os campos necessarios");
    ...
    @Override
    @Transactional
    public void updateTelefoneEspecifico(Long id, Long idTelefone, TelefoneDTO dto) {
        if (dto == null)
            throw new ValidationException("dto", "Informe os campos necessarios");
    ...
    @Override
    @Transactional
    public void updateTelefone(Long id, List<TelefoneDTO> dto) {
        if (dto == null)
            throw new ValidationException("dto", "Informe os campos necessarios");
