...
// import br.unitins.tp1.dto.lote.LoteResponseDTO;
// import br.unitins.tp1.model.pedido.Lote;
// import br.unitins.tp1.service.lote.LoteService;
...
//     @GET
//     @Path("/search/capacete")
//     @RolesAllowed({ "Administrador", "Funcionario" })
//     public Response findByCapacete(@QueryParam("idCapacete") Long idCapacete) {
//         LOG.infof("Buscando lotes para o capacete com ID: %d.", idCapacete);
//         return Response.ok(LoteResponseDTO.valueOf(loteService.findByCapacete(idCapacete))).build();
//     }
