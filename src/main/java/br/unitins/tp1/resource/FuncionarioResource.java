...
import br.unitins.tp1.dto.usuario.FuncionarioResponseDTO;
...
import br.unitins.tp1.service.file.FuncionarioFileServiceImpl;
import br.unitins.tp1.service.usuario.FuncionarioService;
...
public class FuncionarioResource {
    ...
    @RolesAllowed({ "Adm" })
    @Path("/{id}")
    public Response update(@PathParam("id") Long id, @Valid FuncionarioUpdateDTO funcionario) {
    ...
    @RolesAllowed({ "Adm" })
    @Path("/{id}/enderecos")
    public Response updateEndereco(@PathParam("id") Long id, @Valid List<EnderecoDTO> endereco) {
    ...
    @RolesAllowed({ "Adm" })
    @Path("/{id}/telefones")
    public Response updateTelefone(@PathParam("id") Long id, @Valid List<TelefoneDTO> telefone) {
