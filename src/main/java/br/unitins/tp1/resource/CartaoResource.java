...
import br.unitins.tp1.dto.pagamento.CartaoResponseDTO;
import br.unitins.tp1.model.pagamento.Cartao;
import br.unitins.tp1.service.CartaoService;
...
public class CartaoResource {
    ...
    @POST
    @RolesAllowed("User")
    public Response create(@Valid CartaoDTO dto) {
    ...
    @Path("/{id}")
    @RolesAllowed("User")
    public Response update(@PathParam("id") Long id, @Valid CartaoDTO dto) {
