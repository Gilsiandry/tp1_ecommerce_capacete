...
public class CapaceteResource {
    ...
    @GET
    public List<CapaceteResponseDTO> listarTodos() {
    ...
    @POST
    public Response inserir(@Valid CapaceteRequestDTO dto, @Context UriInfo uriInfo) {
        CapaceteResponseDTO criado = service.inserir(dto);
    ...
    @PUT
    @Path("/{id}")
    public Response atualizar(@PathParam("id") Long id, @Valid CapaceteRequestDTO dto) {
